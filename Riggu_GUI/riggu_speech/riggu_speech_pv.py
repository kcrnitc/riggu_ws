...
class riggutalk():
    def __init__(self) -> None:
        ...
        ACCESS_KEY = "I26nlMjgQ4FwucPBI60ZnRmqzqFX6b0KK/w6ANl3Ab3k12KanL+wCg==" #acess key for porcupine
        KEYWORD_FILE_PATH = cwd+"/riggu_speech/hey-Raghu_en_linux_v2_2_0.ppn"
